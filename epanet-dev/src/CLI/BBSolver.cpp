...
int bbsolver(int argc, char *argv[])
{
  ...
  //   if (!is_feasible)
  //   {
  //     counter.set_feasible(is_feasible, "actuations");
  //     continue;
  //   }

  //   is_feasible = process_node(inpFile, counter, nodes, tanks, pump_names, cost, verbose, save_project);
