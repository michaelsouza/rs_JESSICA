...
Emitter::Emitter() : flowCoeff(0), expon(0.0), timePattern(0) {}
...
//  Finds the outflow and its derivative from an emitter at a given pressure
//  head.
