...
Pattern::Pattern(string name_, int type_)
    : Element(name_), type(type_), currentIndex(0), interval(0) {}

Pattern::~Pattern() { factors.clear(); }
...
FixedPattern::FixedPattern(string name_)
    : Pattern(name_, FIXED_PATTERN), startTime(0) {}
...
VariablePattern::~VariablePattern() { times.clear(); }
