...
public:
  ...
  bool changeStatus(int newStatus, bool makeChange, const std::string reason,
                    std::ostream &msgLog);
  bool changeSetting(double newSetting, bool makeChange,
...
inline int Valve::type() { return Link::VALVE; }

inline bool Valve::isPRV() { return valveType == PRV; }

inline bool Valve::isPSV() { return valveType == PSV; }
