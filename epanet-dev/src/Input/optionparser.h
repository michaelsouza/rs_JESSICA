...
private:
  std::string getEpanet3Keyword(const std::string &s1, const std::string &s2,
                                std::string &value);
  void setOption(const std::string &keyword, const std::string &value,
                 Network *network);
  void parseQualOption(const std::string &s2, const std::string &s3,
                       Network *network);
  void parseReportItems(int nodesOrLinks, Network *network, int nTokens,
                        std::string *tokens);
  void parseReportField(Network *network, int nTokens, std::string *tokens);
};
